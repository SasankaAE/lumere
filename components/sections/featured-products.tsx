...
export function FeaturedProducts() {
  return (
    <section id="products" className="relative py-24 sm:py-32" aria-label="Featured products">
      <div className="container-lux">
        <Reveal className="mb-16 flex flex-col items-start justify-between gap-6 sm:flex-row sm:items-end">
          ...
          <p className="max-w-sm text-ink-soft">
            Each product is designed to work in concert &mdash; layered
            together or used alone, without compromise.
          </p>
        </Reveal>
            ...
            >
              ...
              <div className="flex flex-1 flex-col gap-2 p-6">
                <div className="flex items-start justify-between gap-2">
                  ...
                  <span className="whitespace-nowrap font-display text-lg">{product.price}</span>
                </div>
                <p className="text-sm text-ink-soft">{product.tagline}</p>
                <p className="mt-1 text-sm leading-relaxed text-ink-soft">{product.description}</p>
